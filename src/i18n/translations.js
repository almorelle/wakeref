export const t = {
  fr: {
    ...
    quizScoreMsgs: [
      "Continue à t'entraîner, les figures ne t'attendent pas ! 🏄",
      'Pas mal, mais le wake a encore des secrets pour toi.',
      'Bon niveau ! Tu commences à bien reconnaître.',
      'Très bon score ! Tu maîtrises bien les figures.',
      'Parfait ! Tu devrais devenir juge de compétition. 🏆',
    ],
  ...
  en: {
    ...
    quizScoreMsgs: [
      ...
      'Perfect! You should become a competition judge. 🏆',
    ],
