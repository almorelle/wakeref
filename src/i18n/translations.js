export const t = {
  fr: {
    ...
    tileCompetitionsSub:   'Le calendrier du cable : ce qui arrive, et les vidéos de ce qui est passé.',
    ...
    competitions: {
      title:      'Compétitions',
      subtitle:   'Le calendrier du cable en France : dates, lieux, live et vidéos. On référence, on ne diffuse pas.',
  ...
  en: {
    ...
    tileCompetitionsSub:   'The cable calendar: what is coming, and videos of what has been.',
    ...
    competitions: {
      title:      'Competitions',
      subtitle:   'The French cable calendar: dates, venues, live streams and videos. We list them, we don\'t broadcast them.',
